...
<!-- Featured Section Start -->
    <h1 class="text-3xl mt-10 mb-5 px-4">Running Auctions</h1>
    ...
    <h1 class="text-3xl mt-10 mb-5 px-4">Upcoming Auctions</h1>
    <div class="grid grid-cols-4 gap-3">
...
<footer class="p-10 footer bg-gray-800 text-base-content">
  <div>
    <svg width="25" height="25" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd" class="fill-current text-white">
    ...
    <div>
        <p class="text-white uppercase font-bold">Auction System
            <br>
        </p>
