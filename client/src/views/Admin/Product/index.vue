<template>
  ...
  <div class="mb-4 mx-124">
    <link-button class="float-left" to="admin.product.create" name="Add Product"
      >Add Product</link-button
    >
    <input
      @keyup="searchProduct"
      class="input input-primary input-bordered float-right"
      type="text"
      placeholder="Search..."
    />
  </div>
    ...
    >
      <div
        ...
        class="
          ...
          rounded-t-lg
          dark:bg-gray-800
          sm:rounded-lg sm:m-4 sm:max-w-5xl
        "
        role="dialog"
        id="modal"
      >
            ...
            <div class="max-h-96 overflow-y-auto flex flex-col gap-4">
              ...
              <div class="w-full flex items-center gap-4">
                ...
                <label class="w-full block text-sm">
                  ...
                  <input
                    type="number"
                    required
                    v-model="form_data.expected_value"
                    class="
                      block
                      w-full
                      mt-1
              ...
              <div class="w-full flex items-center gap-4">
                ...
                <label class="w-full block text-sm">
                  ...
                  >
                    <option class="py-1" value="">--Select Grade--</option>
                    <option
                      class="py-1"
                      :value="'A' + i"
                      v-for="i in 6"
              ...
              <div class="w-full flex items-center gap-4">
                <label class="w-full block text-sm mt-4">
                  ...
                  <textarea
                    v-model="form_data.specification"
                    required
                    class="
                      block
                      w-full
...
export default {
  ...
  methods: {
    ...
    paginateItems() {
      const start =
        (this.pagination.activePage - 1) * this.pagination.dataCount;
      this.products = this.products_data.slice(
        start,
        start + this.pagination.dataCount
      );
    },
