            ...
            >
              ...
              >
                  ...
                  <div class="flex items-center text-sm">
                    <div>
                      <p class="font-semibold">
                        {{
                          auction.result_time
                            ? moment(auction.result_time).format("MMMM Do YYYY")
                            : "N/A"
                        }}
                      </p>
                    </div>
                ...
                <td class="px-4 py-3">
                  ...
                  >
                    <div>
                      <p class="font-semibold">UNPAID</p>
                    </div>
                  </div>
                  <div
                    class="flex items-center text-sm"
                  ...
                  >
                    <div>
                      <p class="font-semibold">Cut Fee</p>
                    </div>
                  </div>
                </td>
                <td class="px-4 py-3">
                  <div
                    class="flex items-center text-sm"
                    v-if="auction.is_delivered == 0 || !auction.winner_bid"
                  >
                    <div>
                      <p class="font-semibold">
                        {{ 0 }}
                  ...
                  <div
                    class="flex items-center text-sm"
                    v-else-if="auction.is_delivered == 1"
                  >
                    <div>
                      <p class="font-semibold">
                  ...
                  <div
                    class="flex items-center text-sm"
                    v-else-if="auction.is_delivered == 2 && auction.winner_bid"
                  >
                    <div>
                      <p class="font-semibold">
                        {{ auction.base_price }}
