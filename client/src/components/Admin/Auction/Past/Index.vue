          ...
          >
            ...
            >
              ...
              <td
                ...
                v-else-if="auction.is_delivered == 2"
              >
                <button @click="Details(index)" type="submit">
                  ...
                  <span class="btn btn-xs"> Cut Fee Applied </span>
                </button>
              </td>
              <td
                class="px-4 py-3 text-xs"
                v-else-if="auction.is_delivered == 0"
              >
                <h2 class="px-4 py-3 text-xs" v-if="result">
                  <button @click="updateAuctionStatus(index)" type="submit">
                    ...
                    <span class="btn btn-error btn-xs"> Cutfee </span>
                  </button>
                </h2>
                <h2 class="px-4 py-3 text-xs" v-else-if="!result">
                  <button @click="updateAuctionStatus(index)" type="submit">
                    <!-- <span class="mt-2 px-2 py-1 text-sm font-semibold leading-tight text-red-700 bg-red-100 rounded-full dark:bg-red-700 dark:text-red-100"> -->
                    <span class="btn btn-xs btn-accent"> Pending </span>
                  </button>
                </h2>
              </td>
            </tr>
...
export default {
  ...
  methods: {
    ...
    paginateItems() {
      ...
      this.auctions = this.auctions_data.slice(
        start,
